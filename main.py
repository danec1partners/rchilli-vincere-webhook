...
def webhook():
    try:
        ...
        print("📄 Raw request body (bytes):", request.data)
        print("📄 Raw request body (decoded):", request.data.decode('utf-8', errors='replace'))
        ...
        if 'application/json' in content_type:
            try:
                ...
                return jsonify({"error": "Invalid JSON received", "message": str(e)}), 400
        ...
        print("❌ Webhook error (catch-all):", str(e))
